...
urlpatterns = [
    ...
    path('persons/detail/<int:pk>/', PersonDetailView.as_view(), name='person_detail'),
    path('persons/update/<int:pk>/', PersonUpdateView.as_view(), name='person_update'),
    path('persons/delete/<int:pk>/', PersonDeleteView.as_view(), name='person_delete'),
