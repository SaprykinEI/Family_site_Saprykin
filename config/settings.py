...
SECRET_KEY = 'django-insecure-(dic^%e04oxa9b2#wy%v(aug96e-h$n$s$0#ex#=3)!k!-x(1$'
...
PAD_DATABASE = os.getenv("MS_PAD_DATABASE") # Database for executing the command to create a database
...
# Включить кеширование через Redis
CACHE_ENABLED = True
...
LOGIN_REDIRECT_URL = 'family_tree:index'
LOGOUT_REDIRECT_URL = 'family_tree:index'
LOGIN_URL = '/users/'
